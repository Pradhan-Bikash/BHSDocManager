<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SiteApp.master" CodeBehind="WebFrmEmployee.aspx.cs" Inherits="BPWEBAccessControl.WebFrmEmployee" %>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-row">
                                   ...
                                   <div class="form-group col-sm-3 required">
                                        <asp:Label ID="lblEmpId" CssClass="ctrlStyle_Label" runat="server" Text="Employee Id"></asp:Label>
                                         <asp:TextBox ID="txtEmpId" CssClass="form-control form-group-sm" runat="server"></asp:TextBox>
                                   </div>
                                   <div class="form-group col-sm-3 required">
                                        <asp:Label ID="lblEmpName" CssClass="ctrlStyle_Label" runat="server" Text="Employee Name"></asp:Label>
                                         <asp:TextBox ID="txtEmpName" CssClass="form-control form-group-sm" runat="server"></asp:TextBox>
                                   </div>
                                    <div class="form-group col-sm-3 required">
                                        <asp:Label ID="lblDeptId" CssClass="ctrlStyle_Label" runat="server" Text="Department Id"></asp:Label>
                                         <asp:DropDownList ID="ddldeptId" CssClass="form-control form-group-sm" runat="server"></asp:DropDownList>
                                   </div>
                                   <div class="form-group col-sm-3 required">
                                        <asp:Label ID="lblDOJ" CssClass="ctrlStyle_Label" runat="server" Text="Date of Joining"></asp:Label>
                                   ...
                                   <div class="form-group col-sm-3 required">
                                        <asp:Label ID="lblSalary" CssClass="ctrlStyle_Label" runat="server" Text="Salary"></asp:Label>
                                         <asp:TextBox ID="txtSalary" CssClass="form-control form-group-sm" runat="server"></asp:TextBox>
                                   </div>
                               </div>
                            </div>
