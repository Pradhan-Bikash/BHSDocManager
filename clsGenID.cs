...
namespace bplib
{
    public class clsGenID
    {
        ...
        public void GenEmpIdTest(string strEntryDate, string strFieldName, out string strID)
        {
            ConnectionManager.DAL.ConManager objCoManager;
            string strSql = "";
            System.Data.DataSet dsLocal = null;
            ...
            try
            {
                ...
                SB = new System.Text.StringBuilder(strEntryDate);
                strID = SB.Replace(bplib.clsWebLib.getUserDateSeparator().ToString(), "").ToString();               //04262023

                //strID = strID.Remove(0, 6);                                          //23  () position to 6th position are removed                         

                stringArray = strID.ToCharArray();
                Array.Reverse(stringArray);
                strID = new string(stringArray);                                                     //32026240
