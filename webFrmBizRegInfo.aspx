<%@ Page Title="" Language="C#" MasterPageFile="~/SiteApp.master" AutoEventWireup="true" CodeBehind="webFrmBizRegInfo.aspx.cs" Inherits="PWOMS.webFrmBizRegInfo" %>
                        ...
                        <div class="container-fluid" style="margin-top: 10px;">
                            ...
                            <div class="form-row">
                                <div class="container-fluid myFrame">
                                    ...
                                    <div class="form-group col-sm-3 required">
                                        <asp:Label ID="lblBRNumber" CssClass="ctrlStyle_Label" runat="server" Text="Registration Number"></asp:Label>
                                        <asp:TextBox ID="txtBRNumber" CssClass="form-control form-group-sm" runat="server"></asp:TextBox>
                                    </div>
                                    <div class="form-group col-sm-3 required">
                                        <asp:Label ID="lblExpiryDate" CssClass="ctrlStyle_Label" runat="server" Text="Expiry Date"></asp:Label>
                                        <asp:TextBox ID="txtExpiryDate" runat="server" CssClass="form-control form-group-sm" placeholder="dd-MMM-yyyy"></asp:TextBox>
                                        <ajaxToolkit:CalendarExtender runat="server" TargetControlID="txtExpiryDate" Format="dd-MMM-yyyy" CssClass="ajaxcald"></ajaxToolkit:CalendarExtender>
                                    </div>

                                    <div class="form-group col-sm-3 required">
                                        <asp:Label ID="lblRegisteredAddress" CssClass="ctrlStyle_Label" runat="server" Text="Registered Address"></asp:Label>
                                        <asp:TextBox ID="txtRegisteredAddress" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                    <div class="form-group col-sm-3">
