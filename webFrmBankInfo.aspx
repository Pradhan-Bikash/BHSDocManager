<%@ Page Title="" Language="C#" MasterPageFile="~/SiteApp.master" AutoEventWireup="true" CodeBehind="~/webFrmBankInfo.aspx.cs" Inherits="PWOMS.webFrmBankInfo" %>
                        ...
                        <div class="container-fluid" style="margin-top: 10px;">
                            ...
                            <div class="form-row">
                                <div class="container-fluid myFrame">
                                    ...
                                    <div class="form-group col-sm-3 required">
                                        <asp:Label ID="lblBankName" CssClass="ctrlStyle_Label" runat="server" Text="Bank Name"></asp:Label>
                                        <asp:TextBox ID="txtBankName" CssClass="form-control form-group-sm" runat="server"></asp:TextBox>
                                    </div>
                                    <div class="form-group col-sm-3 required">
                                        <asp:Label ID="lblBankAccountName" CssClass="ctrlStyle_Label" runat="server" Text="Bank Account Name"></asp:Label>
                                        <asp:TextBox ID="txtBankAccountName" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>

                                    <div class="form-group col-sm-3 required">
                                        <asp:Label ID="lblBankAddress" CssClass="ctrlStyle_Label" runat="server" Text="Bank Address"></asp:Label>
                                        <asp:TextBox ID="txtBankAddress" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                    <div class="form-group col-sm-3 required">
                                        <asp:Label ID="lblBankCode" CssClass="ctrlStyle_Label" runat="server" Text="Bank Code"></asp:Label>
                                        <asp:TextBox ID="txtBankCode" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                    <div class="form-group col-sm-3 required">
                                        <asp:Label ID="lblBranchCode" CssClass="ctrlStyle_Label" runat="server" Text="Branch Code"></asp:Label>
                                        <asp:TextBox ID="txtBranchCode" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                    <div class="form-group col-sm-3 required">
                                        <asp:Label ID="lblAccountCode" CssClass="ctrlStyle_Label" runat="server" Text="Account Code"></asp:Label>
                                        <asp:TextBox ID="txtAccountCode" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>

                                    <div class="form-group col-sm-3">
                                        <asp:Label ID="lblSWIFTCode" CssClass="ctrlStyle_Label" runat="server" Text="SWIFT Code"></asp:Label>
                                        <asp:TextBox ID="txtSWIFTCode" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                    <div class="form-group col-sm-3">
                                        <asp:Label ID="lblSORTCode" CssClass="ctrlStyle_Label" runat="server" Text="SORT Code"></asp:Label>
                                        <asp:TextBox ID="txtSORTCode" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                    <div class="form-group col-sm-3">
                                        <asp:Label ID="lblIBANsCode" CssClass="ctrlStyle_Label" runat="server" Text="IBANs Code"></asp:Label>
                                        <asp:TextBox ID="txtIBANsCode" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                    <div class="form-group col-sm-3">
                                        <asp:Label ID="lblBSBCode" CssClass="ctrlStyle_Label" runat="server" Text="BSB Code"></asp:Label>
                                        <asp:TextBox ID="txtBSBCode" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>

                                    <div class="form-group col-sm-3">
                                        <asp:Label ID="lblCorrespondentBankName" CssClass="ctrlStyle_Label" runat="server" Text="Correspondent Bank Name"></asp:Label>
                                        <asp:TextBox ID="txtCorrespondentBankName" runat="server" CssClass="form-control form-group-sm"></asp:TextBox>
                                    </div>
                                    <div class="form-group col-sm-3">
                                        <asp:Label ID="lblCorrespendentBankAddress" CssClass="ctrlStyle_Label" runat="server" Text="Correspendent Bank Address"></asp:Label>
                                        <asp:TextBox ID="txtCorrespendentBankAddress" runat="server" CssClass="form-control form-group-sm"></asp:TextBox>
                                    </div>
                                    <div class="form-group col-sm-3">
                                        <asp:Label ID="lblAuthorisedSignatory" CssClass="ctrlStyle_Label" runat="server" Text="Authorised Signatory"></asp:Label>
                                        <div class="input-group">
                                            <asp:TextBox ID="txtAuthorisedSignatory" CssClass="form-control form-group-sm" runat="server" Enabled="False"></asp:TextBox>
                                            <span class="input-group-btn input-space">
                                                <asp:Button ID="Button_FindAuthorisedSignatory" runat="server" Text="..." CssClass="form-control form-group-sm"
                                                    OnClick="Button_FindAuthorisedSignatory_Click"></asp:Button>
                                            </span>
                                        </div>
                                        <asp:Label ID="lblAuthorisedSignatoryID" CssClass="ctrlStyle_Label" runat="server" Text="" Visible="false"></asp:Label>
                                    </div>
                                    <div class="form-group col-sm-3">
                                        <asp:Label ID="lblRemarks" CssClass="ctrlStyle_Label" runat="server" Text="Remarks"></asp:Label>
                                        <asp:TextBox ID="txtRemarks" runat="server" CssClass="form-control form-group-sm"></asp:TextBox>
                                    </div>
