    ...
    $.fn.extend({
        passwordRequirements: function(options) {
            ...
            return this.each(function() {
				...
				o.infoMessage = 'The Maximum password length is ' + o.numCharacters + ' characters and must contain at least 1 Alpha character, 1 Number, and 1 Special Character, Do not use space within character.';
				// Add Variables for the li elements
				var numCharactersUI = '<li class="pr-numCharacters"><span></span>Maximum 10 characters</li>',
					useLowercaseUI = '',
					useUppercaseUI = '',
					useNumbersUI   = '',
					useSpecialUI   = '';
				...
				//}
				if (o.useLowercase === true || o.useUppercase === true) {
					useLowercaseUI = '<li class="pr-useLowercase"><span></span>Alpha character</li>';
				}
				...
				$(this).on("keyup focus", function (){
					...
					// Check # of characters
					if (thisVal.length >0 && thisVal.length < o.numCharacters ) {
					...
					if (o.useLowercase === true) {
						if (thisVal.match(lowerCase) || thisVal.match(upperCase) ) {
